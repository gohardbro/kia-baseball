    ...
    <div class="row mt-2">
        <div class="col-lg-2">
            <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item"><a class="nav-link ${ menu eq 'ticket'? 'active': '' }" href="/admin/ticket">티켓 예매 현황</a></li>
                <li class="nav-item"><a class="nav-link ${ menu eq 'uniformList'? 'active': '' }" href="/admin/uniformList">상품 구매 현황</a></li>
            </ul>
        </div>
        <div class="col-lg-10">